  ...
  const onSubmit = async (data: DeviceFormInput) => {
    try {
      if (mode === 'create') {
        ...
        await updateMutation.mutateAsync({ id: deviceId, data })
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          {errors.deviceType && (
            <p className="text-xs font-medium text-destructive">{errors.deviceType.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1">
          ...
          {errors.condition && (
            <p className="text-xs font-medium text-destructive">{errors.condition.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        />
        {errors.serialNumber && (
          <p className="text-xs font-medium text-destructive">{errors.serialNumber.message}</p>
        )}
      </div>
      ...
      <div className="space-y-1">
        ...
        />
        {errors.accessories && (
          <p className="text-xs font-medium text-destructive">{errors.accessories.message}</p>
        )}
      </div>
